...
namespace Odyssey {
	...
	/// <summary>
	/// Summary for BSuicideForm
	/// </summary>
	public ref class BSuicideForm : public System::Windows::Forms::Form
	{
	public:
		BSuicideForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BSuicideForm::typeid));
			...
			this->button3->Location = System::Drawing::Point(756, 432);
			...
			this->button3->Click += gcnew System::EventHandler(this, &BSuicideForm::button3_Click);
			// 
			// broomtxt1
			// 
			...
			this->broomtxt1->Location = System::Drawing::Point(30, 286);
			...
			this->Name = L"BSuicideForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"BSuicideForm";
			this->Load += gcnew System::EventHandler(this, &BSuicideForm::BSuicideForm_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void BSuicideForm_Load(System::Object^ sender, System::EventArgs^ e) {
		

	}
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Hide();
		IntroForm^ frr = gcnew IntroForm();
