...
namespace Odyssey {
	...
	/// <summary>
	/// Summary for AtticForm
	/// </summary>
	public ref class AtticForm : public System::Windows::Forms::Form
	{
	public:
		AtticForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(AtticForm::typeid));
			...
			this->button2->Location = System::Drawing::Point(536, 424);
			this->button2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(164, 35);
			this->button2->TabIndex = 25;
			this->button2->Text = L"Ignore";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &AtticForm::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &AtticForm::button1_Click);
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(436, 394);
			...
			this->label1->Size = System::Drawing::Size(771, 36);
			this->label1->TabIndex = 22;
			this->label1->Text = L"You are now at the Attic where the unknown lies. As you scan your eyes around the"
				L" area with the help of flashlight, \r\nall you see were dusty boxes.";
			// 
			// AtticForm
			// 
			...
			this->Name = L"AtticForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"AtticForm";
			this->Load += gcnew System::EventHandler(this, &AtticForm::AtticForm_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void AtticForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
