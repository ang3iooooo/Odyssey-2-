...
namespace Odyssey {
	...
	/// <summary>
	/// Summary for BReadForm
	/// </summary>
	public ref class BReadForm : public System::Windows::Forms::Form
	{
	public:
		BReadForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BReadForm::typeid));
			...
			this->broomtxt1->Location = System::Drawing::Point(16, 33);
			this->broomtxt1->Margin = System::Windows::Forms::Padding(7, 0, 7, 0);
			this->broomtxt1->Name = L"broomtxt1";
			this->broomtxt1->Size = System::Drawing::Size(945, 54);
			...
			this->button3->Location = System::Drawing::Point(784, 429);
			...
			this->button3->Click += gcnew System::EventHandler(this, &BReadForm::button3_Click);
			// 
			// BReadForm
			// 
			...
			this->Name = L"BReadForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"BReadForm";
			this->Load += gcnew System::EventHandler(this, &BReadForm::BReadForm_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void BReadForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Hide();
		BKnifeForm^ kni = gcnew BKnifeForm();
