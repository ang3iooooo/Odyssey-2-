...
namespace Odyssey {
	...
	/// <summary>
	/// Summary for BKnifeForm
	/// </summary>
	public ref class BKnifeForm : public System::Windows::Forms::Form
	{
	public:
		BKnifeForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BKnifeForm::typeid));
			...
			this->broomtxt1->Location = System::Drawing::Point(42, 71);
			this->broomtxt1->Margin = System::Windows::Forms::Padding(7, 0, 7, 0);
			this->broomtxt1->Name = L"broomtxt1";
			this->broomtxt1->Size = System::Drawing::Size(436, 18);
			this->broomtxt1->TabIndex = 14;
			this->broomtxt1->Text = L"As you flip to the last page, you find a knife tucked in the straps.";
			// 
			// button3
			// 
			...
			this->button3->Location = System::Drawing::Point(767, 422);
			...
			this->button3->Click += gcnew System::EventHandler(this, &BKnifeForm::button3_Click);
			// 
			// BKnifeForm
			// 
			...
			this->Name = L"BKnifeForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"BKnifeForm";
			this->Load += gcnew System::EventHandler(this, &BKnifeForm::BKnifeForm_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void BKnifeForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Hide();
		BStrangerForm^ sra = gcnew BStrangerForm();
