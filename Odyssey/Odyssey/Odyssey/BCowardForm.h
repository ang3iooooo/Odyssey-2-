...
namespace Odyssey {
	...
	/// <summary>
	/// Summary for BCowardForm
	/// </summary>
	public ref class BCowardForm : public System::Windows::Forms::Form
	{
	public:
		BCowardForm(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BCowardForm::typeid));
			...
			this->label1->Location = System::Drawing::Point(567, 36);
			...
			this->button3->Location = System::Drawing::Point(777, 409);
			...
			this->button3->Click += gcnew System::EventHandler(this, &BCowardForm::button3_Click);
			// 
			// broomtxt1
			// 
			...
			this->broomtxt1->Location = System::Drawing::Point(546, 121);
			...
			this->broomtxt1->Size = System::Drawing::Size(433, 144);
			this->broomtxt1->TabIndex = 19;
			...
			this->Name = L"BCowardForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"BCowardForm";
			this->Load += gcnew System::EventHandler(this, &BCowardForm::BCowardForm_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void BCowardForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Hide();
		BCEndForm^ eer = gcnew BCEndForm();
