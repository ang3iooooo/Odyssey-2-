...
namespace Odyssey {
	...
	/// <summary>
	/// Summary for THLadderForm
	/// </summary>
	public ref class THLadderForm : public System::Windows::Forms::Form
	{
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(THLadderForm::typeid));
			...
			this->button3->Location = System::Drawing::Point(543, 431);
			...
			this->button3->Click += gcnew System::EventHandler(this, &THLadderForm::button3_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &THLadderForm::button1_Click);
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(425, 387);
			...
			this->label1->Size = System::Drawing::Size(388, 18);
			this->label1->TabIndex = 20;
			this->label1->Text = L"With the use of ladder, you are now planning to climb up.";
			// 
			// THLadderForm
			// 
			...
			this->Name = L"THLadderForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"THLadderForm";
			this->Load += gcnew System::EventHandler(this, &THLadderForm::THLadderForm_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void THLadderForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Hide();
		THMapFLForm^ ffl = gcnew THMapFLForm();

		ffl->Show();
	}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Hide();
	THClimbUpWOMForm^ cce = gcnew THClimbUpWOMForm();
